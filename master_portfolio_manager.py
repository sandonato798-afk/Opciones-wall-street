...
class MasterPortfolioManager:
    ...
    def get_master_summary(self):
        ...
        return {
            ...
            "strategies_ledger": [
                {
                    "id": "wheel", "name": "Capa 1: La Rueda (Yield Overlay)",
                    "role": "Overlay Sistemático de Puts sobre Margen (Colateral Intocable)",
                    "target_asset": "SPY / QQQ / IWM",
                    "margin_used_usd": 0.0,
                    "pool_access": "POOL 100% UNIFICADO",
                    "net_pnl_usd": wheel_pnl_usd,
                    "premiums_collected_usd": wheel_premiums,
                    "status": "ACTIVE_PUT_OVERLAY"
                },
                {
                    "id": "alpha", "name": "Capa 2: Alpha LEAPS Macro",
                    "role": "Sintéticos Zero-Cost (Mínimo 2 Calls) · Free Runner",
                    "target_asset": "SPY / QQQ / XLK / XLF / XLV",
                    "margin_used_usd": sum(p.get("short_put_current_buyback_cost", 0.0) for p in getattr(self.alpha_bot, "open_positions", []) if not p.get("decoupled")),
                    "pool_access": "POOL 100% UNIFICADO",
                ...
                },
                {
                    ...
                    "role": "Explotación de Pánico & Picos de IV (RSI < 25)",
                    "target_asset": "SPY / QQQ / DIA",
                    "margin_used_usd": margin_rsi,
                    "pool_access": "POOL 100% UNIFICADO",
                ...
                },
                {
                    ...
                    "role": "Scalp ITM · Cierre 15:55 EST con Roll Defensivo",
                    "target_asset": "SPY / QQQ",
                    "margin_used_usd": margin_daytrade,
                    "pool_access": "POOL 100% UNIFICADO",
                    "net_pnl_usd": dt_pnl_usd,
                    "win_rate_pct": dt_stats.get("win_rate", 0.0),
                    "closed_trades_count": len(dt_history),
                    "status": "ACTIVE_INTRADAY" if dt_active else "SCANNING_INTRADAY"
                },
                {
                    "id": "bullmarket", "name": "Capa 5: Bull Market (PMCC Diagonal)",
                    "role": "Long Call ITM (Δ 0.80) + Short Call Semanal (Δ 0.20)",
                    "target_asset": "SPY / QQQ / GLD / IWM / TLT",
                    "margin_used_usd": margin_bullmkt,
                    "pool_access": "POOL 100% UNIFICADO",
